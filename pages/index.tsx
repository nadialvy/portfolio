        ...
        <>
            ...
            <section className="py-24">
                <div className="container mx-auto">
                    ...
                    <p className="text-lg mt-2 text-center text-gray-600"> Get to know me briefly</p>
                </div>
